...
public interface NeihanApi {
     ...
     * @return
     */
    @GET("neihan/stream/mix/v1/?mpic=1&webp=1&essence=1&message_cursor=-1&do00le_col_mode=0&ac=wifi&channel=360&aid=7" +
            "&app_name=joke_essay&device_platform=android&ssmix=a")
