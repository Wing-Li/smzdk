        ...
        if (COMMENT_TYPE_HOT == mCommentType) {
            ...
            holder.replyNum.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putString(Constans.EASSAY_DETAIL_MGROUP_ID, String.valueOf(data.getComment_id()));
                    bundle.putString(Constans.EASSAY_DETAIL_NAME, String.valueOf(data.getUser_name()));
                    bundle.putString(Constans.EASSAY_DETAIL_ICON, String.valueOf(data.getAvatar_url()));
